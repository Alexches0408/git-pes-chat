...
const MNewChatIcon = ({ onClick }) => {
  ...
  let content;
    content = (
      ...
      <path d="M42.0712 27H27.929" stroke="#708AB9" stroke-width="1.5" stroke-linecap="round"/>
      <path d="M35 19.9289V34.071" stroke="#708AB9" stroke-width="1.5" stroke-linecap="round"/>
      </g>
      <defs>
      <filter id="filter0_d_5519_58636" x="0.4" y="0.4" width="68.2" height="57.2" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
