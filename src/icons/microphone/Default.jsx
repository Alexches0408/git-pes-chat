...
const MicrophoneIconDefault = ({ onClick }) => {
  ...
  let content;
    content = darkMode ? (
      ...
      <path d="M30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15Z" fill="#EAEEF1" fill-opacity="0.2"/>
      <path d="M15.0128 5.83398H15.0009C12.5879 5.83398 10.6318 7.32098 10.6318 9.15528V15.0127C10.6318 16.847 12.5879 18.334 15.0009 18.334H15.0128C17.4257 18.334 19.3818 16.847 19.3818 15.0127V9.15528C19.3818 7.32098 17.4257 5.83398 15.0128 5.83398Z" stroke="#B5BEC7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M22 15.0898C22 18.4132 18.8657 21.1078 15 21.1078C11.1343 21.1078 8 18.4232 8 15.0898" stroke="#B5BEC7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M11.0529 25H18.9467" stroke="#B5BEC7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M10.9255 9.40625H14.9886" stroke="#B5BEC7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M10.9254 12.2363H14.9884" stroke="#B5BEC7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M10.9255 15.0645H14.9886" stroke="#B5BEC7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M14.9996 21.1172V24.9994" stroke="#B5BEC7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
