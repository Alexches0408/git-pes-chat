...
const ConMenShareIcon = () => {
  ...
  content = (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M9.29622 14.3882L13.2415 10.4429L9.29622 6.49756M0.897949 10.4429H12.4525" stroke={strokeColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
